...
#define DEF_MAIL_NAME		"Rmail v1.8 Ramiel"
...
/* Main database */
#define VAR_RMAIL_MTADB_HOST	"rmail_mtadb_host"
#define DEF_RMAIL_MTADB_HOST	"localhost"
extern char *var_rmail_mtadb_host;

#define VAR_RMAIL_MTADB_PORT	"rmail_mtadb_port"
#define DEF_RMAIL_MTADB_PORT	3306
extern int var_rmail_mtadb_port;

#define VAR_RMAIL_MTADB_USER	"rmail_mtadb_user"
#define DEF_RMAIL_MTADB_USER	"rmail"
extern char *var_rmail_mtadb_user;

#define VAR_RMAIL_MTADB_PASS	"rmail_mtadb_pass"
#define DEF_RMAIL_MTADB_PASS	"password"
extern char *var_rmail_mtadb_pass;

#define VAR_RMAIL_MTADB_NAME	"rmail_mtadb_name"
#define DEF_RMAIL_MTADB_NAME	"rmail_main"
extern char *var_rmail_mtadb_name;

#define VAR_RMAIL_MTADB_INTERACTIVE	"rmail_mtadb_interactive"
#define DEF_RMAIL_MTADB_INTERACTIVE	1
extern bool var_rmail_mtadb_interactive;


/* Record database */
#define VAR_RMAIL_RECDB_HOST	"rmail_recdb_host"
#define DEF_RMAIL_RECDB_HOST	"localhost"
extern char *var_rmail_recdb_host;

#define VAR_RMAIL_RECDB_PORT	"rmail_recdb_port"
#define DEF_RMAIL_RECDB_PORT	3306
extern int var_rmail_recdb_port;

#define VAR_RMAIL_RECDB_USER	"rmail_recdb_user"
#define DEF_RMAIL_RECDB_USER	"rmail"
extern char *var_rmail_recdb_user;

#define VAR_RMAIL_RECDB_PASS	"rmail_recdb_pass"
#define DEF_RMAIL_RECDB_PASS	"password"
extern char *var_rmail_recdb_pass;

#define VAR_RMAIL_RECDB_NAME	"rmail_recdb_name"
#define DEF_RMAIL_RECDB_NAME	"rmail_main"
extern char *var_rmail_recdb_name;

#define VAR_RMAIL_RECDB_INTERACTIVE	"rmail_recdb_interactive"
#define DEF_RMAIL_RECDB_INTERACTIVE	1
extern bool var_rmail_recdb_interactive;


/* Auth database */
#define VAR_RMAIL_AUTDB_HOST	"rmail_autdb_host"
#define DEF_RMAIL_AUTDB_HOST	"localhost"
extern char *var_rmail_autdb_host;

#define VAR_RMAIL_AUTDB_PORT	"rmail_autdb_port"
#define DEF_RMAIL_AUTDB_PORT	3306
extern int var_rmail_autdb_port;

#define VAR_RMAIL_AUTDB_USER	"rmail_autdb_user"
#define DEF_RMAIL_AUTDB_USER	"rmail"
extern char *var_rmail_autdb_user;

#define VAR_RMAIL_AUTDB_PASS	"rmail_autdb_pass"
#define DEF_RMAIL_AUTDB_PASS	"password"
extern char *var_rmail_autdb_pass;

#define VAR_RMAIL_AUTDB_NAME	"rmail_autdb_name"
#define DEF_RMAIL_AUTDB_NAME	"rmail_main"
extern char *var_rmail_autdb_name;

#define VAR_RMAIL_AUTDB_INTERACTIVE	"rmail_autdb_interactive"
#define DEF_RMAIL_AUTDB_INTERACTIVE	1
extern bool var_rmail_autdb_interactive;


/* Cache database */
#define VAR_RMAIL_CACDB_HOST	"rmail_cacdb_host"
#define DEF_RMAIL_CACDB_HOST	"localhost"
extern char *var_rmail_cacdb_host;

#define VAR_RMAIL_CACDB_PORT	"rmail_cacdb_port"
#define DEF_RMAIL_CACDB_PORT	3306
extern int var_rmail_cacdb_port;

#define VAR_RMAIL_CACDB_USER	"rmail_cacdb_user"
#define DEF_RMAIL_CACDB_USER	"rmail"
extern char *var_rmail_cacdb_user;

#define VAR_RMAIL_CACDB_PASS	"rmail_cacdb_pass"
#define DEF_RMAIL_CACDB_PASS	"password"
extern char *var_rmail_cacdb_pass;

#define VAR_RMAIL_CACDB_NAME	"rmail_cacdb_name"
#define DEF_RMAIL_CACDB_NAME	"rmail_main"
extern char *var_rmail_cacdb_name;

#define VAR_RMAIL_CACDB_INTERACTIVE	"rmail_cacdb_interactive"
#define DEF_RMAIL_CACDB_INTERACTIVE	1
extern bool var_rmail_cacdb_interactive;


/* Bulletin database */
#define VAR_RMAIL_BULDB_HOST	"rmail_buldb_host"
#define DEF_RMAIL_BULDB_HOST	"localhost"
extern char *var_rmail_buldb_host;

#define VAR_RMAIL_BULDB_PORT	"rmail_buldb_port"
#define DEF_RMAIL_BULDB_PORT	3306
extern int var_rmail_buldb_port;

#define VAR_RMAIL_BULDB_USER	"rmail_buldb_user"
#define DEF_RMAIL_BULDB_USER	"rmail"
extern char *var_rmail_buldb_user;

#define VAR_RMAIL_BULDB_PASS	"rmail_buldb_pass"
#define DEF_RMAIL_BULDB_PASS	"password"
extern char *var_rmail_buldb_pass;

#define VAR_RMAIL_BULDB_NAME	"rmail_buldb_name"
#define DEF_RMAIL_BULDB_NAME	"rmail_main"
extern char *var_rmail_buldb_name;

#define VAR_RMAIL_BULDB_INTERACTIVE	"rmail_buldb_interactive"
#define DEF_RMAIL_BULDB_INTERACTIVE	1
extern bool var_rmail_buldb_interactive;


/* Webmail database */
#define VAR_RMAIL_WEBDB_HOST	"rmail_webdb_host"
#define DEF_RMAIL_WEBDB_HOST	"localhost"
extern char *var_rmail_webdb_host;

#define VAR_RMAIL_WEBDB_PORT	"rmail_webdb_port"
#define DEF_RMAIL_WEBDB_PORT	3306
extern int var_rmail_webdb_port;

#define VAR_RMAIL_WEBDB_USER	"rmail_webdb_user"
#define DEF_RMAIL_WEBDB_USER	"rmail"
extern char *var_rmail_webdb_user;

#define VAR_RMAIL_WEBDB_PASS	"rmail_webdb_pass"
#define DEF_RMAIL_WEBDB_PASS	"password"
extern char *var_rmail_webdb_pass;

#define VAR_RMAIL_WEBDB_NAME	"rmail_webdb_name"
#define DEF_RMAIL_WEBDB_NAME	"rmail_main"
extern char *var_rmail_webdb_name;

#define VAR_RMAIL_WEBDB_INTERACTIVE	"rmail_webdb_interactive"
#define DEF_RMAIL_WEBDB_INTERACTIVE	1
extern bool var_rmail_webdb_interactive;
 ...
 /*
	* Main Tables related start
	*/

/* ACL IP */
#define VAR_RMAIL_ACLIP_TABLE	"rmail_aclip_table"
#define DEF_RMAIL_ACLIP_TABLE	"acl_ip"
extern char *var_rmail_aclip_table;

#define VAR_RMAIL_ACLIP_IPFIELD	"rmail_aclip_ipfield"
#define DEF_RMAIL_ACLIP_IPFIELD	"s_ip"
extern char *var_rmail_aclip_ipfield;

#define VAR_RMAIL_ACLIP_TIMEFIELD	"rmail_aclip_timefield"
#define DEF_RMAIL_ACLIP_TIMEFIELD	"s_time"
extern char *var_rmail_aclip_timefield;

#define VAR_RMAIL_ACLIP_TYPEFIELD	"rmail_aclip_typefield"
#define DEF_RMAIL_ACLIP_TYPEFIELD	"s_type"
extern char *var_rmail_aclip_typefield;

#define VAR_RMAIL_ACLIP_CODEFIELD	"rmail_aclip_codefield"
#define DEF_RMAIL_ACLIP_CODEFIELD	"s_code"
extern char *var_rmail_aclip_codefield;

#define VAR_RMAIL_ACLIP_MSGFIELD	"rmail_aclip_msgfield"
#define DEF_RMAIL_ACLIP_MSGFIELD	"s_msg"
extern char *var_rmail_aclip_msgfield;

#define VAR_RMAIL_ACLIP_REASONFIELD	"rmail_aclip_reasonfield"
#define DEF_RMAIL_ACLIP_REASONFIELD	"s_reason"
extern char *var_rmail_aclip_reasonfield;

#define VAR_RMAIL_ACLIP_ADDTIMEFIELD	"rmail_aclip_addtimefield"
#define DEF_RMAIL_ACLIP_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_aclip_addtimefield;

#define VAR_RMAIL_ACLIP_ALLOWTAG	"rmail_aclip_allowtag"
#define DEF_RMAIL_ACLIP_ALLOWTAG	"A"
extern char *var_rmail_aclip_allowtag;

#define VAR_RMAIL_ACLIP_DENYTAG	"rmail_aclip_denytag"
#define DEF_RMAIL_ACLIP_DENYTAG	"D"
extern char *var_rmail_aclip_denytag;

#define VAR_RMAIL_ACLIP_PASSTAG   "rmail_aclip_passtag"
#define DEF_RMAIL_ACLIP_PASSTAG   "P"
extern char *var_rmail_aclip_passtag;

#define VAR_RMAIL_ACLIP_TIMEPASSTAG "rmail_aclip_timepasstag"
#define DEF_RMAIL_ACLIP_TIMEPASSTAG "TP"
extern char *var_rmail_aclip_timepasstag;

#define VAR_RMAIL_ACLIP_TIMEDENYTAG "rmail_aclip_timedenytag"
#define DEF_RMAIL_ACLIP_TIMEDENYTAG "TD"
extern char *var_rmail_aclip_timedenytag;

#define VAR_RMAIL_ACLIP_DEFAULTTAG    "rmail_aclip_defaulttag"
#define DEF_RMAIL_ACLIP_DEFAULTTAG    "D"
extern char *var_rmail_aclip_defaulttag;

#define VAR_RMAIL_ACLIP_DEFAULTCODE   "rmail_aclip_defaultcode"
#define DEF_RMAIL_ACLIP_DEFAULTCODE   460
extern int var_rmail_aclip_defaultcode;

#define VAR_RMAIL_ACLIP_JAILTIME      "rmail_aclip_jailtime"
#define DEF_RMAIL_ACLIP_JAILTIME      3600
extern int var_rmail_aclip_jailtime;

/* ACL Domain */
#define VAR_RMAIL_ACLDN_TABLE   "rmail_acldn_table"
#define DEF_RMAIL_ACLDN_TABLE   "acl_dn"
extern char *var_rmail_acldn_table;

#define VAR_RMAIL_ACLDN_DNFIELD "rmail_acldn_dnfield"
#define DEF_RMAIL_ACLDN_DNFIELD "s_domain"
extern char *var_rmail_acldn_dnfield;

#define VAR_RMAIL_ACLDN_TIMEFIELD "rmail_acldn_timefield"
#define DEF_RMAIL_ACLDN_TIMEFIELD "s_time"
extern char *var_rmail_acldn_timefield;

#define VAR_RMAIL_ACLDN_CODEFIELD "rmail_acldn_codefield"
#define DEF_RMAIL_ACLDN_CODEFIELD "s_code"
extern char *var_rmail_acldn_codefield;

#define VAR_RMAIL_ACLDN_MSGFIELD  "rmail_acldn_msgfield"
#define DEF_RMAIL_ACLDN_MSGFIELD  "s_msg"
extern char *var_rmail_acldn_msgfield;

#define VAR_RMAIL_ACLDN_REASONFIELD "rmail_acldn_reasonfield"
#define DEF_RMAIL_ACLDN_REASONFIELD "s_reason"
extern char *var_rmail_acldn_reasonfield;

#define VAR_RMAIL_ACLDN_ADDTIMEFIELD	"rmail_acldn_addtimefield"
#define DEF_RMAIL_ACLDN_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_acldn_addtimefield;

/* ACL MX */
#define VAR_RMAIL_ACLMX_TABLE   "rmail_aclmx_table"
#define DEF_RMAIL_ACLMX_TABLE   "acl_mx"
extern char *var_rmail_aclmx_table;

#define VAR_RMAIL_ACLMX_IPFIELD "rmail_aclmx_ipfield"
#define DEF_RMAIL_ACLMX_IPFIELD "s_ip"
extern char *var_rmail_aclmx_ipfield;

#define VAR_RMAIL_ACLMX_FQDNFIELD "rmail_aclmx_fqdnfield"
#define DEF_RMAIL_ACLMX_FQDNFIELD "s_fqdn"
extern char *var_rmail_aclmx_fqdnfield;

#define VAR_RMAIL_ACLMX_REASONFIELD "rmail_aclmx_reasonfield"
#define DEF_RMAIL_ACLMX_REASONFIELD "s_reason"
extern char *var_rmail_aclmx_reasonfield;

#define VAR_RMAIL_ACLMX_ADDTIMEFIELD	"rmail_aclmx_addtimefield"
#define DEF_RMAIL_ACLMX_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_aclmx_addtimefield;

/* RC IP */
#define VAR_RMAIL_RCIP_ENABLE   "rmail_rcip_enable"
#define DEF_RMAIL_RCIP_ENABLE   1
extern bool var_rmail_rcip_enable;

#define VAR_RMAIL_RCIP_TABLE    "rmail_rcip_table"
#define DEF_RMAIL_RCIP_TABLE    "rc_ip"
extern char *var_rmail_rcip_table;

#define VAR_RMAIL_RCIP_IPFIELD  "rmail_rcip_ipfield"
#define DEF_RMAIL_RCIP_IPFIELD  "s_ip"
extern char *var_rmail_rcip_ipfield;

#define VAR_RMAIL_RCIP_REASONFIELD  "rmail_rcip_reasonfield"
#define DEF_RMAIL_RCIP_REASONFIELD  "s_reason"
extern char *var_rmail_rcip_reasonfield;

#define VAR_RMAIL_RCIP_ADDTIMEFIELD	"rmail_rcip_addtimefield"
#define DEF_RMAIL_RCIP_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_rcip_addtimefield;

/* RC From */
#define VAR_RMAIL_RCFROM_ENABLE   "rmail_rcfrom_enable"
#define DEF_RMAIL_RCFROM_ENABLE   1
extern bool var_rmail_rcfrom_enable;

#define VAR_RMAIL_RCFROM_TABLE    "rmail_rcfrom_table"
#define DEF_RMAIL_RCFROM_TABLE    "rc_from"
extern char *var_rmail_rcfrom_table;

#define VAR_RMAIL_RCFROM_FROMFIELD  "rmail_rcfrom_fromfield"
#define DEF_RMAIL_RCFROM_FROMFIELD  "s_from"
extern char *var_rmail_rcfrom_fromfield;

#define VAR_RMAIL_RCFROM_CODEFIELD  "rmail_rcfrom_codefield"
#define DEF_RMAIL_RCFROM_CODEFIELD  "s_code"
extern char *var_rmail_rcfrom_codefield;

#define VAR_RMAIL_RCFROM_MSGFIELD   "rmail_rcfrom_msgfield"
#define DEF_RMAIL_RCFROM_MSGFIELD   "s_msg"
extern char *var_rmail_rcfrom_msgfield;

#define VAR_RMAIL_RCFROM_TIMEFIELD  "rmail_rcfrom_timefield"
#define DEF_RMAIL_RCFROM_TIMEFIELD  "s_time"
extern char *var_rmail_rcfrom_timefield;

#define VAR_RMAIL_RCFROM_REASONFIELD  "rmail_rcfrom_reasonfield"
#define DEF_RMAIL_RCFROM_REASONFIELD  "s_reason"
extern char *var_rmail_rcfrom_reasonfield;

#define VAR_RMAIL_RCFROM_ADDTIMEFIELD	"rmail_rcfrom_addtimefield"
#define DEF_RMAIL_RCFROM_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_rcfrom_addtimefield;

/* RC Options */
#define VAR_RMAIL_RCACCT_ENABLE   "rmail_rcacct_enable"
#define DEF_RMAIL_RCACCT_ENABLE   0
extern bool var_rmail_rcacct_enable;

#define VAR_RMAIL_RCAUTH_ENABLE   "rmail_rcauth_enable"
#define DEF_RMAIL_RCAUTH_ENABLE   0
extern bool var_rmail_rcauth_enable;

#define VAR_RMAIL_RCPOP3_ENABLE   "rmail_rcpop3_enable"
#define DEF_RMAIL_RCPOP3_ENABLE   1
extern bool var_rmail_rcpop3_eable;

#define VAR_RMAIL_RCPOP3_EXPIRE   "rmail_rcpop3_expire"
#define DEF_RMAIL_RCPOP3_EXPIRE   300
extern int var_rmail_rcpop3_expire;

/* tbl: Domains */
#define VAR_RMAIL_TRANSPORT_TABLE   "rmail_transport_table"
#define DEF_RMAIL_TRANSPORT_TABLE   "domains"
extern char *var_rmail_transport_table;

#define VAR_RMAIL_TRANSPORT_IDXFIELD  "rmail_transport_idxfield"
#define DEF_RMAIL_TRANSPORT_IDXFIELD  "s_idx"
extern char *var_rmail_transport_idxfield;

#define VAR_RMAIL_TRANSPORT_DOMAINFIELD "rmail_transport_domainfield"
#define DEF_RMAIL_TRANSPORT_DOMAINFIELD "s_domain"
extern char *var_rmail_transport_domainfield;

#define VAR_RMAIL_TRANSPORT_BASEDIRFIELD  "rmail_transport_basedirfield"
#define DEF_RMAIL_TRANSPORT_BASEDIRFIELD  "s_basedir"
extern char *var_rmail_transport_basedirfield;

/* tbl: DomainRewrite */
#define VAR_RMAIL_DOMAINREWRITE_TABLE "rmail_domainrewrite_table"
#define DEF_RMAIL_DOMAINREWRITE_TABLE "domainrewrite"
extern char *var_rmail_domainrewrite_table;

#define VAR_RMAIL_DOMAINREWRITE_FROMFIELD "rmail_domainrewrite_fromfield"
#define DEF_RMAIL_DOMAINREWRITE_FROMFIELD "s_writefrom"
extern char *var_rmail_domainrewrite_fromfield;

#define VAR_RMAIL_DOMAINREWRITE_TOFIELD "rmail_domainrewrite_tofield"
#define DEF_RMAIL_DOMAINREWRITE_TOFIELD "s_writeto"
extern char *var_rmail_domainrewrite_tofield;

/* tbl: HostMap */
#define VAR_RMAIL_HOSTMAP_TABLE   "rmail_hostmap_table"
#define DEF_RMAIL_HOSTMAP_TABLE   "hostmap"
extern char *var_rmail_hostmap_table;

#define VAR_RMAIL_HOSTMAP_DOMAINFIELD "rmail_hostmap_domainfield"
#define DEF_RMAIL_HOSTMAP_DOMAINFIELD "s_domain"
extern char *var_rmail_hostmap_domainfield;

#define VAR_RMAIL_HOSTMAP_NODENAMEFIELD   "rmail_hostmap_nodenamefield"
#define DEF_RMAIL_HOSTMAP_NODENAMEFIELD   "s_nodename"
extern char *var_rmail_hostmap_nodenamefield;

#define VAR_RMAIL_HOSTMAP_HOSTNAMEFIELD   "rmail_hostmap_hostnamefield"
#define DEF_RMAIL_HOSTMAP_HOSTNAMEFIELD   "s_hostname"
extern char *var_rmail_hostmap_hostnamefield;

/* tbl: MailUser */
#define VAR_RMAIL_MAILUSER_TABLE    "rmail_mailuser_table"
#define DEF_RMAIL_MAILUSER_TABLE    "mailuser"
extern char *var_rmail_mailuser_table;

#define VAR_RMAIL_MAILUSER_DOMAINFIELD  "rmail_mailuser_domainfield"
#define DEF_RMAIL_MAILUSER_DOMAINFIELD  "s_domain"
extern char *var_rmail_mailuser_domainfield;

#define VAR_RMAIL_MAILUSER_MAILIDFIELD  "rmail_mailuser_mailidfield"
#define DEF_RMAIL_MAILUSER_MAILIDFIELD  "s_mailid"
extern char *var_rmail_mailuser_mailidfield;

#define VAR_RMAIL_MAILUSER_MHOSTFIELD   "rmail_mailuser_mhostfield"
#define DEF_RMAIL_MAILUSER_MHOSTFIELD   "s_mhost"
extern char *var_rmail_mailuser_mhostfield;

#define VAR_RMAIL_MAILUSER_MBOXFIELD    "rmail_mailuser_mboxfield"
#define DEF_RMAIL_MAILUSER_MBOXFIELD    "s_mbox"
extern char *var_rmail_mailuser_mboxfield;

#define VAR_RMAIL_MAILUSER_STATUFIELD   "rmail_mailuser_statufield"
#define DEF_RMAIL_MAILUSER_STATUFIELD   "s_statu"
extern char *var_rmail_mailuser_statufield;

#define VAR_RMAIL_MAILUSER_SMTPFIELD	"rmail_mailuser_smtpfield"
#define DEF_RMAIL_MAILUSER_SMTPFIELD	"s_smtp"
extern char *var_rmail_mailuser_smtpfield;

#define VAR_RMAIL_MAILUSER_POP3FIELD	"rmail_mailuser_pop3field"
#define DEF_RMAIL_MAILUSER_POP3FIELD	"s_pop3"
extern char *var_rmail_mailuser_pop3field;

#define VAR_RMAIL_MAILUSER_WEBFIELD	"rmail_mailuser_webfield"
#define DEF_RMAIL_MAILUSER_WEBFIELD	"s_web"
extern char *var_rmail_mailuser_webfield;

/* tbl: MailTailer */
#define VAR_RMAIL_MAILTAILER_ENABLE "rmail_mailtailer_enable"
#define DEF_RMAIL_MAILTAILER_ENABLE 0
extern bool var_rmail_tailer_enable;

#define VAR_RMAIL_MAILTAILER_TABLE  "rmail_mailtailer_table"
#define DEF_RMAIL_MAILTAILER_TABLE  "mailtailer"
extern char *var_rmail_mailtailer_table;

#define VAR_RMAIL_MAILTAILER_TEXTFIELD  "rmail_mailtailer_textfield"
#define DEF_RMAIL_MAILTAILER_TEXTFIELD  "s_text"
extern char *var_rmail_mailtailer_textfield;

#define VAR_RMAIL_MAILTAILER_ACTIVEFIELD  "rmail_mailtailer_activefield"
#define DEF_RMAIL_MAILTAILER_ACTIVEFIELD  "s_active"
extern char *var_rmail_mailtailer_activefield;

#define VAR_RMAIL_MAILTAILER_ORDERFIELD "rmail_mailtailer_orderfield"
#define DEF_RMAIL_MAILTAILER_ORDERFIELD "s_order"
extern char *var_rmail_mailtailer_orderfield;

/* tbl: DropDomain */
#define VAR_RMAIL_DROPDOMAIN_ENABLE "rmail_dropdomain_enable"
#define DEF_RMAIL_DROPDOMAIN_ENABLE 1
extern bool var_rmail_dropdomain_enable;

#define VAR_RMAIL_DROPDOMAIN_TABLE  "rmail_dropdomain_table"
#define DEF_RMAIL_DROPDOMAIN_TABLE  "dropdomain"
extern char *var_rmail_dropdomain_table;

#define VAR_RMAIL_DROPDOMAIN_DOMAINFIELD  "rmail_dropdomain_domainfield"
#define DEF_RMAIL_DROPDOMAIN_DOMAINFIELD  "s_domain"
extern char *var_rmail_dropdomain_domainfield;

#define VAR_RMAIL_DROPDOMAIN_REASONFIELD  "rmail_dropdomain_reasonfield"
#define DEF_RMAIL_DROPDOMAIN_REASONFIELD  "s_reason"
extern char *var_rmail_dropdomain_reasonfield;

#define VAR_RMAIL_DROPDOMAIN_ADDTIMEFIELD	"rmail_dropdomain_addtimefield"
#define DEF_RMAIL_DROPDOMAIN_ADDTIMEFIELD	"s_addtime"
extern char *var_rmail_dropdomain_addtimefield;

 /*
	* Main Table related end
	*/


 /*
	* Records Table related start
	*/
/* tbl: MailLog */
#define VAR_RMAIL_MAILLOG_ENABLE    "rmail_maillog_enable"
#define DEF_RMAIL_MAILLOG_ENABLE    0
extern bool var_rmail_maillog_enable;

#define VAR_RMAIL_MAILLOG_TABLE   "rmail_maillog_table"
#define DEF_RMAIL_MAILLOG_TABLE   "maillog"
extern char *var_rmail_maillog_table;

#define VAR_RMAIL_MAILLOG_DOMAINFIELD "rmail_maillog_domainfield"
#define DEF_RMAIL_MAILLOG_DOMAINFIELD "s_domain"
extern char *var_rmail_maillog_domainfield;

#define VAR_RMAIL_MAILLOG_MAILIDFIELD "rmail_maillog_mailidfield"
#define DEF_RMAIL_MAILLOG_MAILIDFIELD "s_mailid"
extern char *var_rmail_maillog_mailidfield;

#define VAR_RMAIL_MAILLOG_IPFIELD "rmail_maillog_ipfield"
#define DEF_RMAIL_MAILLOG_IPFIELD "s_ip"
extern char *var_rmail_maillog_ipfield;

#define VAR_RMAIL_MAILLOG_TYPEFIELD "rmail_maillog_typefield"
#define DEF_RMAIL_MAILLOG_TYPEFIELD "s_type"
extern char *var_rmail_maillog_typefield;

#define VAR_RMAIL_MAILLOG_TIMEFIELD "rmail_maillog_timefield"
#define DEF_RMAIL_MAILLOG_TIMEFIELD "s_time"
extern char *var_rmail_maillog_timefield;

/* tbl: MailRecord */
#define VAR_RMAIL_MAILRECORD_ENABLE "rmail_mailrecord_enable"
#define DEF_RMAIL_MAILRECORD_ENABLE 1
extern bool var_rmail_mailrecord_enable;

#define VAR_RMAIL_MAILRECORD_TABLE  "rmail_mailrecord_table"
#define DEF_RMAIL_MAILRECORD_TABLE  "mailrecord"
extern char *var_rmail_mailrecord_table;

#define VAR_RMAIL_MAILRECORD_DOMAINFIELD  "rmail_mailrecord_domainfield"
#define DEF_RMAIL_MAILRECORD_DOMAINFIELD  "s_domain"
extern char *var_rmail_mailrecord_domainfield;

#define VAR_RMAIL_MAILRECORD_MAILIDFIELD  "rmail_mailrecord_mailidfield"
#define DEF_RMAIL_MAILRECORD_MAILIDFIELD  "s_mailid"
extern char *var_rmail_mailrecord_mailidfield;

#define VAR_RMAIL_MAILRECORD_SMTPIPFIELD  "rmail_mailrecord_smtpipfield"
#define DEF_RMAIL_MAILRECORD_SMTPIPFIELD  "s_smtpip"
extern char *var_rmail_mailrecord_smtpipfield;

#define VAR_RMAIL_MAILRECORD_POP3IPFIELD  "rmail_mailrecord_pop3ipfield"
#define DEF_RMAIL_MAILRECORD_POP3IPFIELD  "s_pop3ip"
extern char *var_rmail_mailrecord_pop3ipfield;

#define VAR_RMAIL_MAILRECORD_WWWIPFIELD   "rmail_mailrecord_wwwipfield"
#define DEF_RMAIL_MAILRECORD_WWWIPFIELD   "s_wwwip"
extern char *var_rmail_mailrecord_wwwipfield;

#define VAR_RMAIL_MAILRECORD_SMTPTIMEFIELD  "rmail_mailrecord_smtptimefield"
#define DEF_RMAIL_MAILRECORD_SMTPTIMEFIELD  "s_smtptime"
extern char *var_rmail_mailrecord_smtptimefield;

#define VAR_RMAIL_MAILRECORD_POP3TIMEFIELD  "rmail_mailrecord_pop3timefield"
#define DEF_RMAIL_MAILRECORD_POP3TIMEFIELD  "s_pop3time"
extern char *var_rmail_mailrecord_pop3timefield;

#define VAR_RMAIL_MAILRECORD_WWWTIMEFIELD   "rmail_mailrecord_wwwtimefield"
#define DEF_RMAIL_MAILRECORD_WWWTIMEFIELD   "s_wwwtime"
extern char *var_rmail_mailrecord_wwwtimefield;

 /*
	* Records Table related end
	*/


 /*
	* Auth Table related start
	*/

/* tbl: MailPass */
#define VAR_RMAIL_AUTH_TABLE    "rmail_auth_table"
#define DEF_RMAIL_AUTH_TABLE    "mailuser"
extern char *var_rmail_auth_table;

#define VAR_RMAIL_AUTH_DOMAINFIELD  "rmail_auth_domainfield"
#define DEF_RMAIL_AUTH_DOMAINFIELD  "s_domain"
extern char *var_rmail_auth_domainfield;

#define VAR_RMAIL_AUTH_MAILIDFIELD  "rmail_auth_mailidfield"
#define DEF_RMAIL_AUTH_MAILIDFIELD  "s_mailid"
extern char *var_rmail_auth_mailidfield;

#define VAR_RMAIL_AUTH_ENCFIELD "rmail_auth_encfield"
#define DEF_RMAIL_AUTH_ENCFIELD "s_encpass"
extern char *var_rmail_auth_encfield;

#define VAR_RMAIL_AUTH_RAWFIELD "rmail_auth_rawfield"
#define DEF_RMAIL_AUTH_RAWFIELD "s_rawpass"
extern char *var_rmail_auth_rawfield;

 /*
	* Auth Table related end
	*/


 /*
	* Cache Table related start
	*/

/* tbl: MailCache */
#define VAR_RMAIL_MAILCACHE_ENABLE  "rmail_mailcache_enable"
#define DEF_RMAIL_MAILCACHE_ENABLE  0
extern bool var_rmail_mailcache_enable;

#define VAR_RMAIL_MAILCACHE_EXPIRE    "rmail_mailcache_expire"
#define DEF_RMAIL_MAILCACHE_EXPIRE    300
extern int var_rmail_mailcache_expire;

#define VAR_RMAIL_MAILCACHE_TABLE    "rmail_mailcache_table"
#define DEF_RMAIL_MAILCACHE_TABLE    "mailcache"
extern char *var_rmail_mailcache_table;

#define VAR_RMAIL_MAILCACHE_DOMAINFIELD  "rmail_mailcache_domainfield"
#define DEF_RMAIL_MAILCACHE_DOMAINFIELD  "s_domain"
extern char *var_rmail_mailcache_domainfield;

#define VAR_RMAIL_MAILCACHE_MAILIDFIELD  "rmail_mailcache_mailidfield"
#define DEF_RMAIL_MAILCACHE_MAILIDFIELD  "s_mailid"
extern char *var_rmail_mailcache_mailidfield;

#define VAR_RMAIL_MAILCACHE_MHOSTFIELD   "rmail_mailcache_mhostfield"
#define DEF_RMAIL_MAILCACHE_MHOSTFIELD   "s_mhost"
extern char *var_rmail_mailcache_mhostfield;

#define VAR_RMAIL_MAILCACHE_MBOXFIELD    "rmail_mailcache_mboxfield"
#define DEF_RMAIL_MAILCACHE_MBOXFIELD    "s_mbox"
extern char *var_rmail_mailcache_mboxfield;

#define VAR_RMAIL_MAILCACHE_STATUFIELD   "rmail_mailcache_statufield"
#define DEF_RMAIL_MAILCACHE_STATUFIELD   "s_statu"
extern char *var_rmail_mailcache_statufield;

#define VAR_RMAIL_MAILCACHE_SMTPFIELD	"rmail_mailcache_smtpfield"
#define DEF_RMAIL_MAILCACHE_SMTPFIELD	"s_smtp"
extern char *var_rmail_mailcache_smtpfield;

#define VAR_RMAIL_MAILCACHE_POP3FIELD	"rmail_mailcache_pop3field"
#define DEF_RMAIL_MAILCACHE_POP3FIELD	"s_pop3"
extern char *var_rmail_mailcache_pop3field;

#define VAR_RMAIL_MAILCACHE_WEBFIELD	"rmail_mailcache_webfield"
#define DEF_RMAIL_MAILCACHE_WEBFIELD	"s_web"
extern char *var_rmail_mailcache_webfield;

#define VAR_RMAIL_MAILCACHE_TIMEFIELD	"rmail_mailcache_timefield"
#define DEF_RMAIL_MAILCACHE_TIMEFIELD	"s_time"
extern char *var_rmail_mailcache_timefield;

/* tbl: MailTrap */
#define VAR_RMAIL_MAILTRAP_ENABLE   "rmail_mailtrap_enable"
#define DEF_RMAIL_MAILTRAP_ENABLE   1
extern bool var_rmail_mailtrap_enable;

#define VAR_RMAIL_MAILTRAP_TABLE    "rmail_mailtrap_table"
#define DEF_RMAIL_MAILTRAP_TABLE    "mailtrap"
extern char *var_rmail_mailtrap_table;

#define VAR_RMAIL_MAILTRAP_IPFIELD  "rmail_mailtrap_ipfield"
#define DEF_RMAIL_MAILTRAP_IPFIELD  "s_ip"
extern char *var_rmail_mailtrap_ipfield;

#define VAR_RMAIL_MAILTRAP_FROMFIELD  "rmail_mailtrap_fromfield"
#define DEF_RMAIL_MAILTRAP_FROMFIELD  "s_from"
extern char *var_rmail_mailtrap_fromfield;

#define VAR_RMAIL_MAILTRAP_BULKFIELD  "rmail_mailtrap_bulkfield"
#define DEF_RMAIL_MAILTRAP_BULKFIELD  "s_bulk"
extern char *var_rmail_mailtrap_bulkfield;

#define VAR_RMAIL_MAILTRAP_WBULKFIELD "rmail_mailtrap_wbulkfield"
#define DEF_RMAIL_MAILTRAP_WBULKFIELD "s_wbulk"
extern char *var_rmail_mailtrap_wbulkfield;

#define VAR_RMAIL_MAILTRAP_SIZEFIELD  "rmail_mailtrap_sizefield"
#define DEF_RMAIL_MAILTRAP_SIZEFIELD  "s_size"
extern char *var_rmail_mailtrap_sizefield;

#define VAR_RMAIL_MAILTRAP_TIMEFIELD  "rmail_mailtrap_timefield"
#define DEF_RMAIL_MAILTRAP_TIMEFIELD  "s_time"
extern char *var_rmail_mailtrap_timefield;

/* MailTrap options */
#define VAR_RMAIL_MAILTRAP_ACLIP_ENABLE   "rmail_mailtrap_aclip_enable"
#define DEF_RMAIL_MAILTRAP_ACLIP_ENABLE   1
extern bool var_rmail_mailtrap_aclip_enable;

#define VAR_RMAIL_MAILTRAP_RCFROM_ENABLE  "rmail_mailtrap_rcfrom_enable"
#define DEF_RMAIL_MAILTRAP_RCFROM_ENABLE  1
extern bool var_rmail_mailtrap_rcfrom_enable;

#define VAR_RMAIL_MAILTRAP_BULKLIMIT  "rmail_mailtrap_bulklimit"
#define DEF_RMAIL_MAILTRAP_BULKLIMIT  300
extern int var_rmail_mailtrap_bulklimit;

#define VAR_RMAIL_MAILTRAP_WBULKLIMIT "rmail_mailtrap_wbulklimit"
#define DEF_RMAIL_MAILTRAP_WBULKLIMIT 30
extern int var_rmail_mailtrap_wbulklimit;

#define VAR_RMAIL_MAILTRAP_SIZELIMIT  "rmail_mailtrap_sizelimit"
#define DEF_RMAIL_MAILTRAP_SIZELIMIT  0
extern int var_rmail_mailtrap_sizelimit;

#define VAR_RMAIL_MAILTRAP_INTERVAL   "rmail_mailtrap_interval"
#define DEF_RMAIL_MAILTRAP_INTERVAL   600
extern int var_rmail_mailtrap_interval;


/* Cache algorithms */
/* HostMap Cache */
#define VAR_RMAIL_HOSTMAPCACHE_ENABLE "rmail_hostmapcache_enable"
#define DEF_RMAIL_HOSTMAPCACHE_ENABLE 0
extern bool var_rmail_hostmapcache_enable;

#define VAR_RMAIL_HOSTMAPCACHE_EXPIRE "rmail_hostmapcache_expire"
#define DEF_RMAIL_HOSTMAPCACHE_EXPIRE 1800
extern int var_rmail_hostmapcache_expire;

/* Domain Cache */
#define VAR_RMAIL_DOMAINCACHE_ENABLE "rmail_domaincache_enable"
#define DEF_RMAIL_DOMAINCACHE_ENABLE 0
extern bool var_rmail_domaincache_enable;

#define VAR_RMAIL_DOMAINCACHE_EXPIRE "rmail_domaincache_expire"
#define DEF_RMAIL_DOMAINCACHE_EXPIRE 1800
extern int var_rmail_domaincache_expire;


 /*
	* Cache Table related end
	*/


 /*
	* Webmail tables related start
	*/
 ...
 /*
	* Bulletin tables related start
	*/

#define VAR_RMAIL_BULLETIN_ENABLE "rmail_bulletin_enable"
#define DEF_RMAIL_BULLETIN_ENABLE 1
extern bool var_rmail_bulletin_enable;

#define VAR_RMAIL_BULRECORD_TABLE "rmail_bulrecord_table"
#define DEF_RMAIL_BULRECORD_TABLE "record"
extern char *var_rmail_bulrecord_table;

#define VAR_RMAIL_BULRECORD_MAILIDFIELD "rmail_bulrecord_mailidfield"
#define DEF_RMAIL_BULRECORD_MAILIDFIELD "s_mailid"
extern char *var_rmail_bulrecord_mailidfield;

#define VAR_RMAIL_BULRECORD_DOMAINFIELD "rmail_bulrecord_domainfield"
#define DEF_RMAIL_BULRECORD_DOMAINFIELD "s_domain"
extern char *var_rmail_bulrecord_domainfield;

#define VAR_RMAIL_BULRECORD_RECORDFIELD "rmail_bulrecord_recordfield"
#define DEF_RMAIL_BULRECORD_RECORDFIELD "s_record"
extern char *var_rmail_bulrecord_recordfield;

#define VAR_RMAIL_BULCONTENT_TABLE  "rmail_bulcontent_table"
#define DEF_RMAIL_BULCONTENT_TABLE  "bulletin"
extern char *var_rmail_bulcontent_table;

#define VAR_RMAIL_BULCONTENT_IDFIELD  "rmail_bulcontent_idfield"
#define DEF_RMAIL_BULCONTENT_IDFIELD  "s_id"
extern char *var_rmail_bulcontent_idfield;

#define VAR_RMAIL_BULCONTENT_ACTIVEFIELD  "rmail_bulcontent_activefield"
#define DEF_RMAIL_BULCONTENT_ACTIVEFIELD  "s_active"
extern char *var_rmail_bulcontent_activefield;

#define VAR_RMAIL_BULCONTENT_UIDLFIELD  "rmail_bulcontent_uidlfield"
#define DEF_RMAIL_BULCONTENT_UIDLFIELD  "s_uidl"
extern char *var_rmail_bulcontent_uidlfield;

#define VAR_RMAIL_BULCONTENT_TIMEFIELD  "rmail_bulcontent_timefield"
#define DEF_RMAIL_BULCONTENT_TIMEFIELD  "s_time"
extern char *var_rmail_bulcontent_timefield;

#define VAR_RMAIL_BULCONTENT_CONTENTFIELD "rmail_bulcontent_contentfield"
#define DEF_RMAIL_BULCONTENT_CONTENTFIELD "s_content"
extern char *var_rmail_bulcontent_contentfield;

 /*
	* Bulletin tables related end
	*/

/* IMAPD */
#define VAR_RMAIL_FOLDER_TABLE	"rmail_folder_table"
#define DEF_RMAIL_FOLDER_TABLE	"folders"
extern char *var_rmail_folder_table;

#define VAR_RMAIL_FOLDER_DOMAINFIELD  "rmail_folder_domainfield"
#define DEF_RMAIL_FOLDER_DOMAINFIELD  "s_domain"
extern char *var_rmail_folder_domainfield;

#define VAR_RMAIL_FOLDER_MAILIDFIELD  "rmail_folder_mailidfield"
#define DEF_RMAIL_FOLDER_MAILIDFIELD  "s_mailid"
extern char *var_rmail_folder_mailidfield;

#define VAR_RMAIL_FOLDER_NAMEFIELD  "rmail_folder_namefield"
#define DEF_RMAIL_FOLDER_NAMEFIELD  "s_foldername"
extern char *var_rmail_folder_namefield;

#define VAR_RMAIL_FOLDER_FLAGFIELD  "rmail_folder_flagfield"
#define DEF_RMAIL_FOLDER_FLAGFIELD  "s_folderflag"
extern char *var_rmail_folder_flagfield;
...
/* quota related */
#define VAR_RMAIL_DEFAULT_QUOTA   "rmail_default_quota"
#define DEF_RMAIL_DEFAULT_QUOTA   50000000
extern int var_rmail_default_quota;

#define VAR_RMAIL_QUOTA_FILE    "rmail_quota_file"
#define DEF_RMAIL_QUOTA_FILE    ".quota"
extern char *var_rmail_quota_file;

#define VAR_RMAIL_QUOTA_TMPFILE   "rmail_quota_tmpfile"
#define DEF_RMAIL_QUOTA_TMPFILE   ".quota-tmp"
extern char *var_rmail_quota_tmpfile;

#define VAR_RMAIL_QUOTA_EXPIRE    "rmail_quota_expire"
#define DEF_RMAIL_QUOTA_EXPIRE    1800
extern int var_rmail_quota_expire;

/* wrong rcpt */
#define VAR_RMAIL_FAKE250_ENABLE    "rmail_fake250_enable"
#define DEF_RMAIL_FAKE250_ENABLE    1
extern bool var_rmail_fake250_enable;

#define VAR_RMAIL_WRONGRCPT_LIMIT   "rmail_wrongrcpt_limit"
#define DEF_RMAIL_WRONGRCPT_LIMIT   5
extern int var_rmail_wrongrcpt_limit;

/* MX? */
#define VAR_RMAIL_ISMX    "rmail_ismx"
#define DEF_RMAIL_ISMX    0
extern bool var_rmail_ismx;
/* Maildir */
#define VAR_RMAIL_MAILDIR_SUFIX "rmail_maildir_sufix"
#define DEF_RMAIL_MAILDIR_SUFIX "/Maildir/"
extern char *var_rmail_maildir_sufix;

#define VAR_RMAIL_DEFAULT_BASEDIR "rmail_default_basedir"
#define DEF_RMAIL_DEFAULT_BASEDIR "/mnt"
extern char *var_rmail_default_basedir;

/* Local user */
#define VAR_RMAIL_ALLOW_LOCAL   "rmail_allow_local"
#define DEF_RMAIL_ALLOW_LOCAL   1
extern bool var_rmail_allow_local;

#define VAR_RMAIL_LOCAL_NEXTHOP "rmail_local_nexthop"
#define DEF_RMAIL_LOCAL_NEXTHOP "localhost"
extern char *var_rmail_local_nexthop;

/* Return Mail */
#define VAR_RMAIL_RETURNMAIL_ENABLE "rmail_returnmail_enable"
#define DEF_RMAIL_RETURNMAIL_ENABLE 0
extern bool var_rmail_returnmail_enable;

/* Deliver */
#define VAR_RMAIL_DEFAULT_DELIVER   "rmail_default_deliver"
#define DEF_RMAIL_DEFAULT_DELIVER   "virtual"
extern char *var_rmail_default_deliver;

/* POP3 Timeout */
#define VAR_RMAIL_POP3D_TMOUT "rmail_pop3d_tmout"
#define DEF_RMAIL_POP3D_TMOUT "300s"
extern int var_rmail_pop3d_tmout;

#define VAR_POP3D_SOFT_ERLIM    "pop3d_soft_error_limit"
#define DEF_POP3D_SOFT_ERLIM    10
extern int var_pop3d_soft_erlim;

#define VAR_POP3D_ERR_SLEEP     "pop3d_error_sleep_time"
#define DEF_POP3D_ERR_SLEEP     "1s"
extern int var_pop3d_err_sleep;

/* IMAP Timeout */
#define VAR_RMAIL_IMAPD_TMOUT "rmail_imapd_tmout"
#define DEF_RMAIL_IMAPD_TMOUT "300s"
extern int var_rmail_imapd_tmout;

#define VAR_IMAPD_SOFT_ERLIM    "imapd_soft_error_limit"
#define DEF_IMAPD_SOFT_ERLIM    10
extern int var_imapd_soft_erlim;

#define VAR_IMAPD_ERR_SLEEP     "imapd_error_sleep_time"
#define DEF_IMAPD_ERR_SLEEP     "1s"
extern int var_imapd_err_sleep;

/* API Timeout */
#define VAR_RMAIL_APID_TMOUT  "rmail_apid_tmout"
#define DEF_RMAIL_APID_TMOUT  "300s"
extern int var_rmail_apid_tmout;

#define VAR_APID_SOFT_ERLIM    "apid_soft_error_limit"
#define DEF_APID_SOFT_ERLIM    10
extern int var_apid_soft_erlim;

#define VAR_APID_ERR_SLEEP     "apid_error_sleep_time"
#define DEF_APID_ERR_SLEEP     "1s"
extern int var_apid_err_sleep;

/* Zipmail */
#define VAR_RMAIL_ZIPMAIL_ENABLE  "rmail_zipmail_enable"
#define DEF_RMAIL_ZIPMAIL_ENABLE  0
extern bool var_rmail_zipmail_enable;

/* POP3PD (pop3 proxy) */
#define VAR_RMAIL_POP3PD_ENABLE     "rmail_pop3pd_enable"
#define DEF_RMAIL_POP3PD_ENABLE     0
extern bool var_rmail_pop3pd_enable;

#define VAR_RMAIL_POP3PD_TARGETPORT   "rmail_pop3pd_targetport"
#define DEF_RMAIL_POP3PD_TARGETPORT   110
extern int var_rmail_pop3pd_targetport;

/* License related */
#define VAR_RMAIL_LICENSE_NAME  "rmail_license_name"
#define DEF_RMAIL_LICENSE_NAME  "Someone Inc."
extern char *var_rmail_license_name;

#define VAR_RMAIL_LICENSE_USERLIMIT "rmail_license_userlimit"
#define DEF_RMAIL_LICENSE_USERLIMIT 10000
extern int var_rmail_license_userlimit;

#define VAR_RMAIL_LICENSE_DOMAINLIMIT "rmail_license_domainlimit"
#define DEF_RMAIL_LICENSE_DOMAINLIMIT 3
extern int var_rmail_license_domainlimit;

#define VAR_RMAIL_LICENSE_KEY   "rmail_license_key"
#define DEF_RMAIL_LICENSE_KEY   ""
extern char *var_rmail_license_key;

#define VAR_RMAIL_VERSION_STR   "v1.8"
#define VAR_RMAIL_PRODUCT_STR   "Rmail"
extern int var_rmail_license_exceed;
